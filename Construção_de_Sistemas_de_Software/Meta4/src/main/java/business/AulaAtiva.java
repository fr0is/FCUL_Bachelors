 ...
 */
@Entity
@NamedQuery(name=AulaAtiva.FIND_BY_ID, query="SELECT a FROM AulaAtiva a WHERE a.id = :" + AulaAtiva.AULAATIVA_ID)
@NamedQuery(name=AulaAtiva.FIND_BY_NOME, query="SELECT a FROM AulaAtiva a WHERE a.nome = :" + AulaAtiva.AULAATIVA_NOME)

@Table(name = "AULAATIVA")
public class AulaAtiva{

	public static final String FIND_BY_ID = "AulaAtiva.findById";
	public static final String AULAATIVA_ID = "id";

	public static final String FIND_BY_NOME = "AulaAtiva.findByNome";
	public static final String AULAATIVA_NOME = "nome";

	@Id @GeneratedValue(strategy = GenerationType.SEQUENCE)
	@Column(name = "AULAATIVA_ID")
	private int id;
	...
	@JoinColumn(name = "AULAATIVA_ID", referencedColumnName = "AULAATIVA_ID")
	private List<Inscricao> inscritos;

	@Column(name = "TOTALINSCRITOS", nullable = false)
	...
	public AulaAtiva inscreve(Inscricao inscricao) {
		if(this.totalInscritos < maxAlunos) {
	...
	public boolean temVagas() {
		return this.totalInscritos < maxAlunos;
	}
	...
	public String verVagas() {
		return "\t"+this.data.toString() + " - " + (this.maxAlunos-this.totalInscritos) + " vagas\n";
	}
